...
bool VOUtility::IsVelocityForbidden(const FVector2D& CandidateVA, const TArray<FVONeighborView>& Neis, const FVector& ActorPos, const FVOParams& Params)
{
...
void VOUtility::BuildVOCones(const TArray<FVONeighborView>& Neis, const FVector& ActorPos, const FVOParams& Params, FVOConesSoA& OutVOCones)
{
...
FVOCone VOUtility::ComputeVOCone(const float R, const FVector2D& C, const FVector2D& Vel, const FVOParams& Params)
{
	FVOCone Cone;
	Cone.Apex = Vel;
...
float VOUtility::ScoreVelocityCandidate(
	const FVector2D& V,
...
void VOUtility::DrawVOCones(const UVOFollowingComponent* Comp, const FVOConesSoA& Cones)
{
...
void VOUtility::DrawCombinedVO(const UVOFollowingComponent* Comp, 
...
void VOUtility::DrawVelocityCandidates(
...
void VOUtility::CollectIntersections(const FVOConesSoA& VOCones, TArray<TArray<FVOConeIntersection>>& IntersectionsByRays)
{
...
void VOUtility::SortIntersectionsByRays(TArray<TArray<FVOConeIntersection>>& IntersectionsByRays)
{
...
int32 VOUtility::CountVOsForPoint(const FVOConesSoA& VOCones, int32 ConeIndexToSkip, const FVector2D& P)
{
	int32 Count = 0;
...
void VOUtility::ClassifySegments(
...
FVector2D VOUtility::SelectBestVelocityFromOutsideSegments(
	const FVector2D& DesiredVel2D,
	const FVector2D& CurVel2D,
	const TArray<FVONeighborView>& Neis,
	const FVector& ActorPos,
